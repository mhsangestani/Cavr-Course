...
; 0000 0092           }
	...
	RJMP _0xB
_0xC:
; 0000 0093       PORTD = 0b11111110;
	LDI  R30,LOW(254)
	OUT  0x12,R30
; 0000 0094       PORTC = seg[digit[3]];
	__GETW1MN _digit,6
	RCALL SUBOPT_0x0
; 0000 0095       delay_ms(10);
; 0000 0096       PORTD = 0b11111101;
	LDI  R30,LOW(253)
	OUT  0x12,R30
; 0000 0097       PORTC = seg[digit[2]];
	__GETW1MN _digit,4
	RCALL SUBOPT_0x0
; 0000 0098       delay_ms(10);
; 0000 0099       PORTD = 0b11111011;
	LDI  R30,LOW(251)
	OUT  0x12,R30
; 0000 009A       PORTC = seg[digit[1]];
	__GETW1MN _digit,2
	RCALL SUBOPT_0x0

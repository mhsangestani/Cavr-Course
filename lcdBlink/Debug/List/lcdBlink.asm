...
_0x0:
	.DB  0x6D,0x6F,0x68,0x61,0x6D,0x6D,0x61,0x64
	.DB  0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 008E // RD - PORTC Bit 1
; 0000 008F // EN - PORTC Bit 2
; 0000 0090 // D4 - PORTC Bit 4
; 0000 0091 // D5 - PORTC Bit 5
; 0000 0092 // D6 - PORTC Bit 6
; 0000 0093 // D7 - PORTC Bit 7
...
; 0000 009A       lcd_gotoxy(4,1);
	LDI  R30,LOW(4)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 009B       lcd_puts("mohammad");
	__POINTW2MN _0x6,0
	RCALL _lcd_puts
